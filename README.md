...
<br> 3.Calculated average products per order by city to understand customer purchasing patterns.</br>
<br> 4.Identified top 3 highest-spending customers per year using ranking functions.</br>
<br> 5.Performed correlation analysis between product price and purchase frequency using NumPy.</br>
<br> 6.Created insightful visualizations with Matplotlib and Seaborn to present sales trends clearly.</br>
